...
/* harmony import */ var _modules_loadPictures__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/loadPictures */ "./src/js/modules/loadPictures.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_loadPictures__WEBPACK_IMPORTED_MODULE_5__["default"])('.styles .row', '.button-styles');
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots;
      var nameArr = input.files[0].name.split('.');
      nameArr[0].length > 6 ? dots = "..." : dots = ".";
      var fileName = nameArr[0].substring(0, 6) + dots + nameArr[1];
...
var forms = function forms(state) {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var dots;
      var nameArr = item.files[0].name.split('.');
      nameArr[0].length > 6 ? dots = "..." : dots = ".";
      var fileName = nameArr[0].substring(0, 6) + dots + nameArr[1];
...
/***/ "./src/js/modules/loadPictures.js":
/*!****************************************!*\
  !*** ./src/js/modules/loadPictures.js ***!
  \****************************************/
/*! exports provided: default */
...
var loadPictures = function loadPictures(wrapperSelector, selectorBtn) {
  var loadMoreBtn = document.querySelector(selectorBtn),
  ...
  var createCards = function createCards(data) {
...
/* harmony default export */ __webpack_exports__["default"] = (loadPictures);
...
var scrolling = function scrolling(upSelector) {
  ...
  window.addEventListener("scroll", function () {
    if (document.documentElement.scrollTop > 1640) {
      console.log('1000');
...
var showPicture = function showPicture(imgSelector) {
